...
<!--          <div class="comment comment-group" @click="commentGroup">
    ...
    <w-dialog v-model="actionVisible" :ok-loading="actionLoading" :width="isMobile ? '100%':'500px'" :title="actionDesc.title" okText="提 交" @ok="doAction">
      <process-action ref="action" @success="handlerOk" @fail="actionLoading = false" :form-data="formData" v-if="actionVisible"
                      ...
                      :action-desc="actionDesc" show-sign/>
    </w-dialog>
  </div>
</template>
