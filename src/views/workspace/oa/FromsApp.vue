<template>
  <div v-loading="loading">
    ...
    <w-dialog v-if="!isMobile" :ok-loading="submitLoading" :title="`发起 - ${selectForm.formName}`" closeFree width="1000px" v-model="openItemDl" okText="提 交" @cancel="openItemDl = false" @ok="submitForm">
      <initiate-process ref="processForm" @render-ok="submitLoading = false" :code="selectForm.formId" v-if="openItemDl" @fail="submitLoading = false" @ok="openItemDl = false, submitLoading = false" />
    </w-dialog>
  </div>
